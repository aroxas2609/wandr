  ...
  return (
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <View style={styles.container}>
        ...
        <Text style={styles.hint}>Search above or tap the map to drop a pin</Text>
        ...
        <View style={styles.footer}>
          <PremiumButton
            label={pin ? 'Use this location' : 'Search or tap the map'}
